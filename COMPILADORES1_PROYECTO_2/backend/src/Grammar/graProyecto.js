...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,6],$V1=[1,5],$V2=[1,7],$V3=[2,5,8,10],$V4=[13,14],$V5=[2,8],$V6=[1,16],$V7=[1,13],$V8=[1,14],$V9=[1,15],$Va=[1,18];
var parser = {trace: function trace () { },
yy: {},
symbols_: {"error":2,"INICIO":3,"INSTRUCCIONES":4,"EOF":5,"INSTRUCCION":6,"PRINT":7,"tacos":8,";":9,"print":10,"(":11,"EXPRESION":12,")":13,"+":14,"STRING_LITERAL":15,"identifier":16,"caracter":17,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",8:"tacos",9:";",10:"print",11:"(",13:")",14:"+",15:"STRING_LITERAL",16:"identifier",17:"caracter"},
productions_: [0,[3,2],[4,2],[4,1],[6,1],[6,2],[6,1],[7,5],[12,0],[12,3],[12,1],[12,1],[12,1],[12,3]],
...
break;
case 5:
this.$ = new tacos($$[$0-1], _$.first_line, _$.first_column);console.log("instruccion TACOS\n \n \n");
break;
case 6:
...
table: [{2:$V0,3:1,4:2,6:3,7:4,8:$V1,10:$V2},{1:[3]},{2:$V0,5:[1,8],6:9,7:4,8:$V1,10:$V2},o($V3,[2,3]),o($V3,[2,4]),{9:[1,10]},o($V3,[2,6]),{11:[1,11]},{1:[2,1]},o($V3,[2,2]),o($V3,[2,5]),o($V4,$V5,{12:12,11:$V6,15:$V7,16:$V8,17:$V9}),{13:[1,17],14:$Va},o($V4,[2,10]),o($V4,[2,11]),o($V4,[2,12]),o($V4,$V5,{12:19,11:$V6,15:$V7,16:$V8,17:$V9}),{9:[1,20]},o($V4,$V5,{12:21,11:$V6,15:$V7,16:$V8,17:$V9}),{13:[1,22],14:$Va},o($V3,[2,7]),o($V4,[2,9]),o($V4,[2,13])],
...
case 7:return 9
break;
case 8:console.log("decremento");return 'decremento'
break;
case 9:return '-'
break;
case 10:console.log("incremento"); return 'incremento'
break;
case 11:return 14
break;
case 12:return '*'
...
rules: [/^(?:\s+)/,/^(?:[ \r\t]+)/,/^(?:\n)/,/^(?:(('[^"]')))/,/^(?:(([0-9]+)(\.([0-9]+))?))/,/^(?:(("[^"]*")))/,/^(?:\/)/,/^(?:;)/,/^(?:--)/,/^(?:-)/,/^(?:\+\+)/,/^(?:\+)/,/^(?:\*)/,/^(?:\^)/,/^(?:%)/,/^(?:<)/,/^(?:>)/,/^(?:<=)/,/^(?:>=)/,/^(?:==)/,/^(?:!=)/,/^(?:\|\|)/,/^(?:&&)/,/^(?:!)/,/^(?:=)/,/^(?:\()/,/^(?:\))/,/^(?:\{)/,/^(?:\})/,/^(?:void\b)/,/^(?:return\b)/,/^(?:if\b)/,/^(?:else\b)/,/^(?:switch\b)/,/^(?:case\b)/,/^(?:default\b)/,/^(?:break\b)/,/^(?:continue\b)/,/^(?:while\b)/,/^(?:do\b)/,/^(?:for\b)/,/^(?:false\b)/,/^(?:true\b)/,/^(?:class\b)/,/^(?:import\b)/,/^(?:char\b)/,/^(?:double\b)/,/^(?:int\b)/,/^(?:String\b)/,/^(?:boolean\b)/,/^(?:(([a-zA-Z_])[a-zA-Z0-9_]*))/,/^(?:$)/,/^(?:.)/],
